      ...
      <Table className={classes.table} aria-label="customized table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="left">Get result</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
            <StyledTableRow key={row.Key}>
              ...
              <StyledTableCell align="left">{row.LastModified}</StyledTableCell>
              <StyledTableCell align="left">
                <Button variant="contained" color="secondary" onClick={() => download(row.Key)}>
                  Download
                </Button>
              </StyledTableCell>
            </StyledTableRow>
